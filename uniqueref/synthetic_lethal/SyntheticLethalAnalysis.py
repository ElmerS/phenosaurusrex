...
class SyntheticLethalAnalysis(object):

	__metaclass__ = ABCMeta

	def __init__(self, replicates={}, controls={}): # replicates must be dict of one or more SLIScreenReplicate Objects, same holds for controls
	...
	def DrawSenseRatioGraph(self, SampleDF, authorized_screens, GraphTitle="Unnamed sample", sag='', oca='gc', textsize='11px', DFLegend=pd.DataFrame()):
		...
		:return: 
		'''
		GM = UserMessages.SenseRatioGraphMessages()
